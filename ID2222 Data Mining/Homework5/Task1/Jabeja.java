...
public class Jabeja {
  ...
  private void sampleAndSwap(int nodeId) {
    ...
    if (config.getNodeSelectionPolicy() == NodeSelectionPolicy.HYBRID
      ...
      // TODO
      // Integer[] nodep_neighbours= new Integer[nodep.getNeighbours().size()];
      // nodep_neighbours = nodep.getNeighbours().toArray(nodep_neighbours);
      // partner = findPartner(nodeId, nodep_neighbours);
